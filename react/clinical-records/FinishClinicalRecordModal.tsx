          ...
          <div className="container-fluid">
            ...
            <div className="alert alert-success d-flex align-items-center mb-4">
              <div>
                ...
                <p className="mb-0">
                  La historia clínica ha sido creada exitosamente. Ahora puede
                  descargar o imprimir los documentos generados.
                </p>
              </div>
            </div>
            ...
            <div className="card border-light mb-4">
              <div className="card-body bg-light rounded">
                ...
                <ul className="mb-0">
                  <li>
                    Descargue los documentos individualmente haciendo clic en el
                    botón de cada tarjeta
                  </li>
                  <li>
                    Revise que toda la información sea correcta antes de
                    imprimir
                  </li>
                </ul>
              </div>
