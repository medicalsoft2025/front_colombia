                      ...
                      body: (data: any) => (
                        <div className="d-flex justify-content-center align-items-center">
                          <Button
                            ...
                            onClick={() =>
                              removeSupply(formSupplies.indexOf(data))
                            }
            ...
            <div className="col-12">
              <div className="card p-3 mt-3">
                <div className="row g-3">
                  <div className="col-md-6">
                    <div className="mb-3">
                      ...
                      <Dropdown
                        ...
                        onChange={(e) =>
                          handleEntityChange("entity_id", e.value)
                        }
                  ...
                  <div className="col-md-6">
                    <div className="mb-3">
                      ...
                      <Dropdown
                        ...
                        onChange={(e) =>
                          handleEntityChange("tax_charge_id", e.value)
                        }
                        options={taxes.map((tax) => ({
                          label: tax.name,
                          value: tax.id,
                  ...
                  <div className="col-md-6">
                    <div className="mb-3">
                      ...
                      <Dropdown
                        ...
                        onChange={(e) =>
                          handleEntityChange("withholding_tax_id", e.value)
                        }
                  ...
                  <div className="col-md-6">
                    <div className="mb-3">
                      <label className="form-label">Tipo de negociación</label>
                      <Dropdown
                        className="w-100"
                        ...
                        optionValue="id"
                        onChange={(e) =>
                          handleEntityChange("negotation_type", e.value)
                        }
                        options={userTypes}
                        placeholder="Seleccionar..."
                      />
                    ...
                    <div className="col-md-6">
                      <div className="mb-3">
                        ...
                        <Dropdown
                          ...
                          optionValue="value"
                          onChange={(e) =>
                            handleEntityChange("category", e.value)
                          }
