...
const PatientFormModal: React.FC<PatientFormModalProps> = ({
  ...
  async function loadResources() {
    const documentTypesData =
      await resourcesAdminService.getHealthDocumentTypes();
  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      if (
        formData.social_security.affiliate_type === "1" ||
        formData.social_security.affiliate_type === "2" ||
        formData.social_security.affiliate_type === "3"
      ) {
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <div>
                      <label className="form-label">Clasificación de Discapacidad</label>
                      <Dropdown
                  ...
                  render={({ field, fieldState }) => (
                    <div className="mb-3">
                      ...
                      <Dropdown
                        appendTo="self"
                        options={[
                          { label: "Urbana", value: "01" },
                          { label: "Rural", value: "02" },
                        ]}
                        placeholder="Seleccione"
                        className={classNames("w-100", {
                          "is-invalid": fieldState.error,
        ...
        <div className="col-md-12">
          <Card title="Seguridad Social" className="mb-4">
            <div className="row">
              ...
              {(watch("social_security.affiliate_type") == "1" ||
                watch("social_security.affiliate_type") == "2" ||
                watch("social_security.affiliate_type") == "3") && (
                  <div className="col-md-12">
                    <Controller
              ...
              {watch("social_security.affiliate_type") == "4" && (
                <div className="col-md-12">
                  <Controller
