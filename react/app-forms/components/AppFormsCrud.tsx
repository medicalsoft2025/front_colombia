...
export const AppFormsCrud: React.FC = () => {
    ...
    const { data: dynamicFormValues, isLoading: isLoadingValues, refetch: refetchDynamicFormValues } = useDynamicFormValuesByForm(dynamic_form_id || '');
    const { createDynamicFormValues, loading: isLoadingCreate } = useDynamicFormValuesCreate();
    const { updateDynamicFormValues, loading: isLoadingUpdate } = useDynamicFormValuesUpdate();
    ...
    const onSubmit = async (data: any) => {
        if (selectedData) {
            await updateDynamicFormValues(selectedData.id, data);
        } else {
            await createDynamicFormValues(dynamic_form_id, data);
        }
    ...
    /**
     * Template para la columna de acciones (Editar/Eliminar)
     */
