...
export const labplusConfigFields: ConfigFieldI[] = [
    {
        field: "LABPLUS_URL",
        label: "URL",
        type: "text"
...
export const dgiiConfigFields: ConfigFieldI[] = [
    {
        field: "DGII_FILE",
...
export const sisproConfigFields: ConfigFieldI[] = [
    {
...
export const aiConfigFields: ConfigFieldI[] = [
    {
        field: "GROQ_API_KEY",
        label: "Groq API Key",
        type: "password"
