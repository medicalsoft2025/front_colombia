...
import { patientDocumentsService, tenantConfigService, patientService } from "../../../services/api/index.js";
...
export const PatientDocumentsTableOld = ({
  refreshData = false,
  onHandleEdit = () => {}
}) => {
  ...
  async function loadPatientDocuments(params = {
    ...
    const url = new URL(`https://erp.medicalsoft.ai/ba001/migracion.php?action=files&client_id=ba001&patient_id=1}`);
